            ...
            <!--begin::Card-->
										<div class="card card-custom gutter-b example example-compact"  style="width:70%;">
											<div class="card-header">
												<h3 class="card-title"> <a href="edit-admin-password.php?adminID=<?php echo $sno;?>" class="btn btn-sm btn btn-secondary font-weight-bold py-2 px-3 px-xxl-5 my-1">Back</a></h3>
																...
																<div class="col-xl-12">
																	...
																	<div class="form-group row">
																		...
																		<div class="col-lg-6 col-xl-6">
                                                                           <div class="btn btn-sm btn-light-success font-weight-bold py-2 px-3 px-xxl-5 my-1">Password Successfully Added</div>
