...
if (isset($_POST['import_subjects'])) {
   ...
   if($_FILES['import']['name']=="")
   {
    ...
    if(!empty($_FILES['import']['name']) && in_array($_FILES['import']['type'],$file_mimes)){
      ...
      header('Location: import-subjects.php?wrongformat=<button  class="btn btn-danger font-weight-bold py-2 px-3 px-xxl-5 my-1">Wrong Format, Upload as CSV</button>');
      exit;
    }
