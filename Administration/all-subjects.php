...
if($addEditStudentM=="YES" && $studentManagement=="YES")
{
 ...
 $exportLink='<li> <form method="post" action="exports/all-subjects-export.php">
 <button name="export" class="btn btn-sm btn-primary font-weight-bold py-2 px-3 px-xxl-5 my-1" style="margin-right:10px;">Export Subject Template in Excel</button>
 </form></li>';
 $importLink='<li><a href="import-subjects.php" class="btn btn-sm btn-warning font-weight-bold py-2 px-3 px-xxl-5 my-1"  style="margin-right:10px;">Import</a></li>';
 }
...
// side bar and header
    ...
    <main class="app-content">
      <div class="app-title">
      <div>
          <h1><i class="fa fa-th-list"></i> All Subjects</h1>
          <p></p>
        </div>
              ...
              <form name="frmUser" method="post" action="">
                <table class="table table-bordered  table-striped" id="sampleTable" style="width:60%; margin-left:18%">
                  ...
                  <tbody>
                   ...
                   ?>
                    <tr>
                      <td><input type="checkbox" name="users[]" value="<?php echo $allSubjectsRow['subjectID']; ?>" class="name" /></td>
                      <td><?php echo $allSubjectsRow['subjectID']; ?></td>
                      <td><?php echo $allSubjectsRow['subjectName'];?></a></td>
