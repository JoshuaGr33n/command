...
if(isset($_POST['confirm']))
{
	...
	$query1 = "SELECT * FROM students where Class ='".$_POST['class']."' and session ='".$_POST['session']."'and Term ='".$_POST['term']."' and student_id= '".$student_id."'";
...
while($c = mysqli_fetch_array( $query ))
{
   ...
   // $_SESSION['regSubSession']= $c['school_session'];
   // $_SESSION['regSubClass'] = $c['class'];
   // $_SESSION['regSubTerm'] = $c['Term'];
   // $_SESSION['regRegNum'] = $c['RegNum'];
...
// side bar and header
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Confirm Student's Current Infomation</h1>
          <p></p>
        </div>
											...
											<form class="form" id="kt_form_1" method="post">
												<div class="card-body">
                                                       ...
                                                       <!-- <div class="form-group row">
																		<label class="col-xl-3 col-lg-3 col-form-label">Subject ID</label>
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-lg form-control-solid" name="subjectID" type="text"/>
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<select class="form-control form-control form-control-lg form-control-solid" name="term">
												...
												<div class="card-footer">
													<div class="row">
														<div class="col-lg-9 ml-lg-auto">
															<input type="submit" class="btn btn-success font-weight-bold mr-2" name="confirm" value="Confirm"/>
