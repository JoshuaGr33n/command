...
$check_results_num_rows = $con->prepare("SELECT * FROM  `results`");
$check_results_num_rows ->execute();                           
$check_results_num_rows ->Store_result();

$results_count = $check_results_num_rows ->num_rows;
?>
      ...
      <div class="row">
        <div class="col-md-6 col-lg-3">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-users fa-3x"></i>
            <div class="info">
              <h5>All Students</h5>
              <p><b><?php echo $allStudentNumber;?></b></p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small warning coloured-icon"><i class="icon fa fa-files-o fa-3x"></i>
            <div class="info">
              ...
              <p><b><?php echo $results_count;?></b></p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
