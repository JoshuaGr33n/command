...
if(isset($_POST['submitbutton']))
{
    ...
    $err4="Password dont match";
        ...
        if($_POST['newPassword']==$_POST['conPassword'] && $_POST['newPassword']!="" && $_POST['conPassword']!="")
        {
   ...
   $updatePasswordQuery = "Update administration set Password = '".$_POST['newPassword']."'
    ...
    if( $updatePasswordResult)
    {
        ...
        header("Location: admin-pass-suc.php?adminID=$sno");
...
if(isset($_POST['genPassword']))
{
    $pass= uniqid();
     ...
     //update administration table
   $genPasswordQuery = "Update administration set Password = '".$pass."'
   ...
   if($genPasswordResult)
   {
        if($email!="")
        {
          $emailSubject="Command Secondary School::Password Reset";
          $mail= mail($email,$emailSubject,$pass,'Command Secondary School');

           if($mail)


            {
                $_SESSION['emailSucceed'] ='<label class="col-xl-3 col-lg-3 col-form-label">Sent To</label>
                <div class="col-lg-6 col-xl-6">
                    <input class="form-control form-control-lg form-control-solid" type="text" value='. $email.' disabled/>
                ...
                header("Location: edit-admin-password-suc.php?adminID=$sno");
               exit;
            }
										...
										<div class="card card-custom gutter-b example example-compact"  style="width:70%;">
											<div class="card-header">
												...
												<div class="card-toolbar">
                                                    ...
                                                    <button name="genPassword" class="btn btn-sm btn-danger font-weight-bold py-2 px-3 px-xxl-5 my-1" style="color:#fff;">Generate New Password</button>
                                                        </form>
                                            ...
                                            <form class="form" method="post">
														...
														<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
															<h3 class="mb-10 font-weight-bold text-dark"><?php echo $errorUpdate;?></h3>
															<div class="row">
																<div class="col-xl-12">
																	...
																	<div class="form-group row">
																		...
																		<div class="col-lg-6 col-xl-6">
                                                                            <input class="form-control form-control-lg form-control-solid" name="newPassword" type="text" value="" />
                                                                            <span class="form-text text-muted" style="color:red;"><?php echo $err1;?></span>
                                                                            <span class="form-text text-muted" style="color:red;"><?php echo $err3;?></span>
                                                                    ...
                                                                    <div class="form-group row">
																		...
																		<div class="col-lg-6 col-xl-6">
                                                                            <input class="form-control form-control-lg form-control-solid" name="conPassword" type="text" value="" />
                                                                            <span class="form-text text-muted" style="color:red;"><?php echo $err2;?></span>
                                                                            <span class="form-text text-muted" style="color:red;"><?php echo $err4;?></span>
																		</div>
																	</div>
														...
														<div>
															...
															<div>
																<input type="submit" name="submitbutton" class="btn btn-success font-weight-bold text-uppercase px-9 py-4" style="margin-left:25%; width:50%" value="Change Password"/>
