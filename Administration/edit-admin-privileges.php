                ...
                if($privilegesRow['siteManagement']=="YES"){
                    ...
                    if($privilegesRow['PinManagement']=="YES"){
                        ...
                        if($privilegesRow['Settings']=="YES"){
                          ...
                          else if($privilegesRow['Settings']=="NO"){
...
if($settings=="YES")
{
 ...
 <div class="col-9 col-form-label">
   <div class="radio-inline">
     <label class="radio radio-success">
     <input type="radio" name="settings"  value="YES" '.$settingsYes.'/>
     <span></span>Yes</label>
     <label class="radio radio-danger">
     <input type="radio" name="settings" value="NO" '.$settingsNo.'/>
     <span></span>No</label>
