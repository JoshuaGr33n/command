...
if(isset($_POST['submitbutton']))
{
   ...
   $updatePasswordQuery = "Update administration set Password = '".$_POST['newPassword']."'
    ...
    if( $updatePasswordResult)
    {
        ...
        header("Location: my-pass-suc.php");
...
if(isset($_POST['genPassword']))
{
   ...
   if($genPasswordResult)
   {
        if($email!="")
        {
          $emailSubject="Command Secondary School:: New Password Generated";
          $mail= mail($email,$emailSubject,$pass,'Command Secondary School');
           ...
           if($mail)
            ...
            {
                $_SESSION['myemailSucceed'] ='<label class="col-xl-3 col-lg-3 col-form-label">Sent To</label>
                ...
                $_SESSION['mygenPass'] = $pass;


              
                header("Location: edit-my-password-suc.php");
               exit;
            }
															...
															<div class="row">
																<div class="col-xl-12">
																	...
																	<div class="form-group row">
																		...
																		<div class="col-lg-6 col-xl-6">
                                                                            <input class="form-control form-control-lg form-control-solid" name="newPassword" type="password" value="" />
                                                                    ...
                                                                    <div class="form-group row">
																		...
																		<div class="col-lg-6 col-xl-6">
                                                                            <input class="form-control form-control-lg form-control-solid" name="conPassword" type="password" value="" />
