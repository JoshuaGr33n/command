...
$usersCount = count($_POST["sessionName"]);
for($i=0;$i<$usersCount;$i++) {
mysqli_query($con, "UPDATE school_session set sessionName='" . $_POST["sessionName"][$i] . "', Status='" . $_POST["status"][$i] . "' WHERE sessionID='" . $_POST["sessionID"][$i] . "'");
}
...
// side bar and header
    ...
    <main class="app-content">
      <div class="app-title">
      <div>
          <h1><i class="fa fa-th-list"></i> Session</h1>
          <p></p>
        </div>
...
$result = mysqli_query($con, "SELECT * FROM school_session WHERE sessionID='" . $_POST["users"][$i] . "'");
...
?>
     ...
     <label class="col-xl-3 col-lg-3 col-form-label">Sessions</label>
      <div class="col-lg-6 col-xl-6">
      
      <input type="hidden" name="sessionID[]"  class="form-control form-control-lg form-control-solid" value="<?php echo $row[$i]['sessionID']; ?>"><input type="text" name="sessionName[]" class="form-control form-control-lg form-control-solid" value="<?php echo $row[$i]['sessionName']; ?>"></td>
       ...
       <div class="form-group row">
     <label class="col-xl-3 col-lg-3 col-form-label">Current</label>
      <div class="col-lg-6 col-xl-6">
      
      <input type="text" name="status[]" class="form-control form-control-lg form-control-solid" value="<?php echo $row[$i]['Status']; ?>"></td>
