...
$usersCount = count($_POST["subjectName"]);
for($i=0;$i<$usersCount;$i++) {
mysqli_query($con, "UPDATE subjects set subjectName='" . $_POST["subjectName"][$i] . "' WHERE subjectID='" . $_POST["subjectID"][$i] . "'");
}
...
$result = mysqli_query($con, "SELECT * FROM subjects WHERE subjectID='" . $_POST["users"][$i] . "'");
...
?>
     ...
     <label class="col-xl-3 col-lg-3 col-form-label">Subjects</label>
      ...
      <input type="hidden" name="subjectID[]"  class="form-control form-control-lg form-control-solid" value="<?php echo $row[$i]['subjectID']; ?>"><input type="text" name="subjectName[]" class="form-control form-control-lg form-control-solid" value="<?php echo $row[$i]['subjectName']; ?>"></td>
