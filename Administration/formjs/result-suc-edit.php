...
for($i=0;$i<$usersCount;$i++) {
  ?>
  <?php 
 $session_for_edit = $_SESSION['searchSession'];
 $term_for_edit = $_SESSION['searchTerm'];
...
$school_class = substr($_SESSION['searchClass'], 0, 3);
if($school_class=="JSS")
{
...
// side bar and header
    ...
    <main class="app-content">
      ...
      <div>
         ...
         <a href="../results-suc.php" class="btn btn-sm btn btn-success font-weight-bold py-2 px-3 px-xxl-5 my-1">Back</a>
