    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
          ...
          <li><a href="all-students.php" class="btn btn-secondary font-weight-bold py-2 px-3 px-xxl-5 my-1" style="margin-right:10px;">Back</a></li>
        </ul>
      </div>
      <!--begin::Card-->
			...
			if (isset ($_GET['wrongClass'])){
			echo "<div class='btn btn-light-danger font-weight-bold'>".$_GET['wrongClass']."</div>"; 
			}?>
      ...
      <?php if (isset ($_GET['wrongformat'])){
            echo $_GET['wrongformat']; }?>                
											...
											<!--begin::Form-->
											<form class="form" id="kt_form_1" method="post" name="frmExcelImport" enctype="multipart/form-data" action="import-students-suc.php">
												<div class="card-body">
                          ...
                          <div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Import Students*</label>
												...
												<div class="card-footer">
													<div class="row">
														<div class="col-lg-9 ml-lg-auto">
															<input type="submit" class="btn btn-success font-weight-bold mr-2" name="import_students" value="Import"/>
