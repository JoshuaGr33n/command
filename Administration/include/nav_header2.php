      ...
      <ul class="app-menu">
        ...
        <?php echo $manageStudentLink;?>
          <ul class="treeview-menu">
            ...
            <?php echo  $importRegSubjectsLink2;?>
            ...
            <li><a class="treeview-item" href="../select-promote-student-category.php"><i class="icon fa fa-circle-o"></i>Promote Students</a></li>
            <?php echo $AddNewStudentLink2;?>
         </ul>
        </li>
         <!--manage students-->
        ...
        <!--manage site-->
         <?php echo $manageSiteLink;?>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="../front-page-manager.php"><i class="icon fa fa-circle-o"></i>Front Page Manager</a></li>
            <li><a class="treeview-item" href="../results-page-manager.php"><i class="icon fa fa-circle-o"></i>Results Page Manager</a></li>
            <li><a class="treeview-item" href="../update-school-details.php"><i class="icon fa fa-circle-o"></i>Update School Details</a></li>
          </ul>
        </li>
        <!--manage site-->
        ...
        <?php echo $managePinLink;?>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="../pin-generator.php"><i class="icon fa fa-circle-o"></i>Pin Generator</a></li>
        ...
        <!--manage pin-->
         ...
         <?php echo $settingsLink2;?>
         <!-- <ul class="treeview-menu">
            <li><a class="treeview-item <?php //echo $setResultMarkCurrentPageTag;?>" href="../set-result-marks.php"><i class="icon fa fa-circle-o"></i>Set Result Marks</a></li>
