										...
										<div class="card card-custom gutter-b example example-compact"  style="width:70%;">
											<div class="card-header">
												...
												<div class="card-toolbar">
                                                    ...
                                                    <a href="my-signature.php" class="btn btn-sm btn-info font-weight-bold py-2 px-3 px-xxl-5 my-1" style="color:#fff; margin-right:5px;">Upload Signature</a>
                                                    <a href="view-my-privileges.php" class="btn btn-sm btn-success font-weight-bold py-2 px-3 px-xxl-5 my-1" style="color:#fff; margin-right:5px;">My Privileges</a>
                                                    
                                                    
                                                    <a href="edit-my-profile.php" class="btn btn-sm btn-danger font-weight-bold py-2 px-3 px-xxl-5 my-1" style="color:#fff;">Edit My Profile</a>
