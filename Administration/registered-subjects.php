...
$current_class = substr($class, 0, 5);
...
$subjectQuery = "SELECT * FROM registered_subjects where StudentID= '".$student_id."' and School='".$School."'and current_class='".$class."'";
...
// side bar and header
    ...
    <main class="app-content">
      <div class="app-title">
      <div>
          <h3><i class="fa fa-th-list"></i> <?php echo $fname?> <?php echo $lname?>::</h3><h4> Current Subjects Offered</h4>
          <p></p>
        </div>
        ...
        <ul class="app-breadcrumb breadcrumb side">
          ...
          <li><a href="all-registered-subjects.php?studentID=<?php echo $student_id;?>" class="btn btn-success font-weight-bold py-2 px-3 px-xxl-5 my-1" style="margin-right:10px;">View all Registered Subjects</a></li>


         
           <?php echo $addSubJectLink;?>

           <li><a href="student-details.php?studentID=<?php echo $student_id;?>" class="btn btn-danger font-weight-bold py-2 px-3 px-xxl-5 my-1" style="margin-right:10px;">Back</a></li>
              ...
              <form name="frmUser" method="post" action="">
                <table class="table table-bordered  table-striped" id="sampleTable" style="width:60%; margin-left:18%">
                  ...
                  <tbody>
                   ...
                   $subjectClass = $row['current_class'];
                    ...
                    <tr>
                      ...
                      <td><?php echo  $subjectClass;?></a></td>
                      <td><?php echo  $term;?> Term</a></td>
