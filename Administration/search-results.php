...
mysqli_select_db($con, 'schoolresultchecker') or die(mysqli_error($con));
	...
	$query1 = "SELECT * FROM results where subject ='".$_POST['subject']."' and school_session ='".$_POST['session']."'and class ='".$_POST['class']."'and Term ='".$_POST['term']."'";
...
{
	$_SESSION['searchSubject'] = $c['subject'];
    $_SESSION['searchSession']= $c['school_session'];
    $_SESSION['searchClass'] = $c['class'];
    $_SESSION['searchTerm'] = $c['Term'];
...
// side bar and header
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Advanced Search</h1>
          <p></p>
        </div>
                                              ...
                                              <?php   while ($allSubjectRow = mysqli_fetch_array($allSubjectResult))
                                               {
                                                 //output all from classes table
                                                  $subject_id =$allSubjectRow['subjectID'];
                                                    $subject_name =$allSubjectRow['subjectName'];
                                                    ?>
