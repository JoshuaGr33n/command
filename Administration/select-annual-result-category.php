...
if(isset($_POST['proceed']))
{
	...
	$query1 = "SELECT * FROM results where  StudentID='".$student_id."' and school_session ='".$_POST['session']."'and class ='".$_POST['class']."'";
...
while($c = mysqli_fetch_array( $query ))
{
    ...
    $_SESSION['annualResultSession']= $c['school_session'];
    $_SESSION['annualResultClass'] = $c['class'];
   
   
    $_SESSION['annualResultStudentID'] = $c['StudentID'];
        ...
        header("Location: annual-result-view.php");
        exit;
...
<html lang="en">
  ...
  <meta name="description" content="">
    ...
    <title>Select Annual Result Category</title>
    <meta charset="utf-8">
    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
          ...
          <li><a href="view-results.php" class="btn btn-success font-weight-bold py-2 px-3 px-xxl-5 my-1" style="margin-right:10px;">Back</a></li>
        </ul>
      </div>
      <!--begin::Card-->
