...
if(isset($_POST['proceed']))
{
	...
	$query1 = "SELECT * FROM results where school_session ='".$_POST['session']."' and class ='".$_POST['class']."'";
...
while($c = mysqli_fetch_array( $query ))
{
    ...
    $_SESSION['promoteStudentSession']= $c['school_session'];
    $_SESSION['promoteStudentClass'] = $c['class'];
   
   
    $_SESSION['promoteStudentStudentID'] = $c['studebt_id'];
        ...
        header("Location: promote-students.php");
        exit;
...
// side bar and header
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Select Annual Result Category</h1>
          <p></p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <!--<li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>-->
          <!--<li class="breadcrumb-item"></li>-->
          <li><a href="set-class-promotion.php" class="btn btn-success font-weight-bold py-2 px-3 px-xxl-5 my-1" style="margin-right:10px;">Set Class Promotion</a></li>
        </ul>
      </div>
      <!--begin::Card-->
												...
												<div class="card-footer">
													<div class="row">
														<div class="col-lg-9 ml-lg-auto">
															<input type="submit" class="btn btn-success font-weight-bold mr-2" name="proceed" value="Proceed"/>
...
<?php unset($_SESSION['promoteStudentSession']);?>