...
if (isset($_POST['proceed'])) { 
    ...
    $_SESSION['promoteSession'] = $_POST['session'];
        ...
        <div class="col-md-12">
          <div class="profile" >
            ...
            <!--begin::Card-->
                          ...
                          <div>
																                <input type="submit" name="proceed" class="btn btn-success font-weight-bold text-uppercase px-9 py-4" style="margin-left:25%; width:50%" value="Proceed"/>
