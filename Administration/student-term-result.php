...
$_SESSION['classResultStudentID']=$student_id;
...
if(isset($_POST["t_remark_button"])) {
            ...
            $ck_row=mysqli_query($con, "SELECT  name, session, term, class, StudentID FROM  remark WHERE name ='Teacher' AND session ='".$_SESSION['classResultSession']."' AND class='".$_SESSION['classResultClass']."' AND term='".$_SESSION['classResultTerm']."' AND StudentID='".$student_id."'  ");
            
            if(mysqli_num_rows($ck_row) < 1){
mysqli_query($con, "INSERT INTO `remark`( `name`, `remark`, `session`,`class`, `term`,`StudentID` ) VALUES ('Teacher','".$_POST['t_remark']."','".$_SESSION['classResultSession']."','".$_SESSION['classResultClass']."', '".$_SESSION['classResultTerm']."','".$student_id."') ");
            }
            ...
            if(mysqli_num_rows($ck_row) == 1) {
              ...
              mysqli_query($con, "UPDATE remark set  remark='" . $_POST["t_remark"] . "' WHERE name ='Teacher' AND session ='".$_SESSION['classResultSession']."' AND StudentID='".$student_id."' AND class='".$_SESSION['classResultClass']."' AND term='".$_SESSION['classResultTerm']."'");
...
$t_remarkQuery = "SELECT * FROM remark WHERE name ='Teacher' AND session ='".$_SESSION['classResultSession']."' AND class='".$_SESSION['classResultClass']."' AND term='".$_SESSION['classResultTerm']."' AND StudentID='".$student_id."'";
...
if(isset($_POST["p_remark_button"])) {
            ...
            $ck_row=mysqli_query($con, "SELECT  name, session, term, class, StudentID FROM  remark WHERE name ='Principal' AND session ='".$_SESSION['classResultSession']."' AND class='".$_SESSION['classResultClass']."' AND term='".$_SESSION['classResultTerm']."' AND StudentID='".$student_id."'  ");
            
            if(mysqli_num_rows($ck_row) < 1){
mysqli_query($con, "INSERT INTO `remark`( `name`, `remark`, `session`,`class`, `term`,`StudentID` ) VALUES ('Principal','".$_POST['p_remark']."','".$_SESSION['classResultSession']."','".$_SESSION['classResultClass']."', '".$_SESSION['classResultTerm']."','".$student_id."') ");
            }
            ...
            if(mysqli_num_rows($ck_row) == 1) {
              ...
              mysqli_query($con, "UPDATE remark set  remark='" . $_POST["p_remark"] . "' WHERE name ='Principal' AND session ='".$_SESSION['classResultSession']."' AND StudentID='".$student_id."' AND class='".$_SESSION['classResultClass']."'AND class='".$_SESSION['classResultClass']."' AND term='".$_SESSION['classResultTerm']."'");
...
//total average
        ...
        $Query = "SELECT StudentReg, SUM(Total) AS TotalTotal, SUM(Average) AS totalaverage FROM results WHERE Class ='".$_SESSION['classResultClass']."' AND school_session ='".$_SESSION['classResultSession']."' AND Term ='".$_SESSION['classResultTerm']."' AND StudentReg ='".$regNum."' AND Publish='Yes'
...
$totalQuery = "SELECT StudentReg, SUM(Total) AS totalsummation FROM results  WHERE Class ='".$_SESSION['classResultClass']."' AND school_session ='".$_SESSION['classResultSession']."' AND Term ='".$_SESSION['classResultTerm']."' AND StudentReg ='".$regNum."' AND Publish = 'Yes'
...
$student_score=mysqli_query($con, "SELECT SUM(Average) AS Average, StudentID FROM `results` WHERE Class ='".$_SESSION['classResultClass']."' AND school_session = '".$_SESSION['classResultSession']."' AND Term = '".$_SESSION['classResultTerm']."' AND Publish='Yes' GROUP BY StudentID ");
...
$sql="SELECT COUNT(countable.StudentReg) as totalClass FROM (SELECT DISTINCT StudentReg FROM `results` WHERE Class ='".$_SESSION['classResultClass']."' AND school_session = '".$_SESSION['classResultSession']."' AND Term = '".$_SESSION['classResultTerm']."') as countable";
...
$resumptionDateQuery = "SELECT * FROM resumption_date WHERE term='$_SESSION[classResultTerm]' AND session='$_SESSION[classResultSession]'";
...
$current_result_class = substr($_SESSION['classResultClass'], 0, 3);
...
if($School=="Junior Secondary School")
{
    ...
    $credit = mysqli_query($con, "SELECT * FROM `results` WHERE school_session='$_SESSION[classResultSession]' AND Term='$_SESSION[classResultTerm]' AND class='$_SESSION[classResultClass]' AND  Grade IN ('A','B','C')  AND StudentReg ='$regNum' AND Publish ='YES' ");
    ...
    $credit = mysqli_query($con, "SELECT * FROM `results` WHERE school_session='$_SESSION[classResultSession]' AND Term='$_SESSION[classResultTerm]' AND class='$_SESSION[classResultClass]' AND  Grade IN ('A1','B2','B3','C4','C5','C6')  AND StudentReg ='$regNum' AND Publish ='YES' ");
    while($row_credit = $credit->fetch_array()){
...
?>
<?php
$school_class = substr($_SESSION['classResultClass'], 0, 3);
if($school_class=="JSS")
{
 $School="Junior Secondary School";
...
$School="Senior Secondary School";
  ...
  $query= $con->prepare("SELECT CA1, CA2, CA3, Exam FROM result_marks  WHERE School = '$School' AND session = '$_SESSION[classResultSession]' AND term = '$_SESSION[classResultTerm]' ");
...
<script language="javascript" src="formjs/student-term-result.js" type="text/javascript"></script>
<!--edit and delete form script-->
...
// side bar and header
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Results For: <?php echo $fname;?> <?php echo $mName;?> <?php echo $lname;?></h3> <?php echo $_SESSION['classResultClass'];?>-<?php echo $_SESSION['classResultTerm'];?> Term-<?php echo $_SESSION['classResultSession'];?></h3>
...
?></strong></p>
          ...
          <p>Commandant's Comment (<?php echo $principal;?>): <strong><?php echo  $commandantsComment;?></strong></p>
              ...
              <div class="form-group row">
                ...
                <table class="table table-hover table-bordered table-striped" id="sampleTable">
                 ...
                 ?>
                  ...
                  <tbody>
                   <?php
                  $searchresultResult = mysqli_query($con, "SELECT * FROM results where StudentID ='".$_GET['studentID']."' and school_session ='". $_SESSION['classResultSession']."'and class ='". $_SESSION['classResultClass']."'and Term ='".$_SESSION['classResultTerm']."'
                  ");
