...
$sucQuery = "SELECT * FROM registered_subjects where StudentID ='". $_SESSION['regRegNum']."' and Session='". $_SESSION['regSubSession']."'and Term='". $_SESSION['regSubTerm']."'and Class='".  $_SESSION['regSubClass']."'";
        $sucResult = mysqli_query($con, $sucQuery);
            ...
            <div class="tile-body">
              ...
              <form name="frmUser" method="post" action="">
                <table class="table table-bordered  table-striped" id="sampleTable" style="width:60%; margin-left:18%">
                 ...
                 {
                     $regSubClass = $Row['Class'];
                     $regSubTerm = $Row['Term'];
                     $regSubSession = $Row['Session'];
