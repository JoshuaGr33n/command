    ...
    <main class="app-content">
      ...
      <!--begin::Card-->
            ...
            echo $_GET['wrongformat']; }?>
											...
											<!--begin::Form-->
											<form class="form" id="kt_form_1" method="POST" name="frmExcelImport" enctype="multipart/form-data" action="upload-result-success.php">
												<div class="card-body">
                                                    ...
                                                    <div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Import Results*</label>
                                                    ...
                                                    <div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Uploaded By *</label>
														<div class="col-lg-9 col-md-9 col-sm-12">
													...
													<div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Publish Now? *</label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<div class="form-check pl-0 radio-inline">
																<label class="radio radio-outline">
																<input type="radio" name="publish" value="Yes" class="form-control form-control-lg form-control-solid"/>
																<span></span>Yes</label>
																<label class="radio radio-outline">
																<input type="radio" name="publish" Value="No" class="form-control form-control-lg form-control-solid"/>
																<span></span>Later</label>
															</div>
															<span class="form-text text-muted">Please select an option</span>
														</div>
													</div>
												...
												<div class="card-footer">
													<div class="row">
														<div class="col-lg-9 ml-lg-auto">
															<input type="submit" class="btn btn-success font-weight-bold mr-2" name="import_result" value="Import"/>
