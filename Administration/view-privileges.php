										...
										<div class="card card-custom gutter-b example example-compact"  style="width:70%;">
											<div class="card-header">
												...
												<div class="card-toolbar">
                                                    ...
                                                    <a href="edit-admin-privileges.php?adminID=<?php echo $sno;?>" class="btn btn-sm btn-success font-weight-bold py-2 px-3 px-xxl-5 my-1" style="color:#fff; margin-right:5px;">View Privileges</a>
                                                    
                                                    
                                                    <a href="edit-admin-profile.php?adminID=<?php echo $sno;?>" class="btn btn-sm btn-danger font-weight-bold py-2 px-3 px-xxl-5 my-1" style="color:#fff;">Edit Profile</a>
											...
											<div class="card-body">
                                                ...
                                                <tr style="background:none;">
                                                  <td><img src="external/media/users/100_2.jpg" style="border: 1px #000 solid" />:</td>  
                                                  <td></td>  
                                                ...
                                                <tr>
                                                  <td>Status:</td>  
                                                  <td><div  style="margin-left:20%"><?php echo $status;?></div></td> 
